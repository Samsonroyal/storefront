...
class Cohort(models.Model):
    ...
    member = models.ForeignKey(IMUser, on_delete=models.CASCADE, related_name='member_cohorts')
...
class CohortMember(models.Model):
    ...
    member = models.ForeignKey(IMUser, on_delete=models.CASCADE, related_name='member_cohort_members')
