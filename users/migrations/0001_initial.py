    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_cohort_members', to='users.imuser')),
            ],
        ),
        migrations.AddField(
            model_name='cohort',
        ...
        migrations.AddField(
            model_name='cohort',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_cohorts', to='users.imuser'),
        ),
    ]
